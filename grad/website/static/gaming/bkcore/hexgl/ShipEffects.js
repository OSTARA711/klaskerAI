// Path: grad/website/static/gaming/bkcore/hexgl/ShipEffects.js
...
bkcore.hexgl.ShipEffects = function(opts)
{
	...
	/*
	 * Particle effects are permanently enabled as part of the
	 * hardwired HIGH-quality rendering profile.
	 */
	this.particles = {
...
bkcore.hexgl.ShipEffects.prototype.update = function(dt)
{
	...
	/*
	 * Transform the reusable particle vectors into ship space.
	 *
	 * The vectors are reset from their normalised source values above
	 * on every frame, avoiding new Vector3 allocations in the update
	 * loop.
	 */
